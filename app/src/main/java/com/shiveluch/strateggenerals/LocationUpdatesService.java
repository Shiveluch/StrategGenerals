...
public class LocationUpdatesService extends Service {
    ...
    static final String SERVERTIME = PACKAGE_NAME + ".SERVERTIME";
...
String addcoord="http://gamestrateg.ru/generals/update_coord.php";
    ...
    private Notification getNotification() {
        ...
        CharSequence text = Utils.getLat(mLocation)+","+Utils.getLon(mLocation);
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.strateg);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.common_google_signin_btn_icon_dark, getString(R.string.launch_activity),
                        activityPendingIntent)
                .addAction(R.drawable.common_full_open_on_phone, getString(R.string.remove_location_updates),
                        servicePendingIntent)
                .setContentText(text)
                .setContentTitle(Utils.getLocationTitle(this))
                .setOngoing(true)
                .setLargeIcon(bitmap)
                .setSmallIcon(R.drawable.strategicon)
    ...
    private int getNotificationIcon() {
        ...
        return useWhiteIcon ? R.drawable.strategicon : R.drawable.strategicon;
    }
...
//        SimpleDateFormat timeFormat = new SimpleDateFormat("yy-MM-dd HH:mm:ss", Locale.UK);
//        String servertime=mSettings.getString("Time","");
//        Date date = new Date();
//        try {
//            date = timeFormat.parse(servertime);
